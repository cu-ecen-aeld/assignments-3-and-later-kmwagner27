...
{
    const char* expected_username = my_username(); // Call my_username() to get the expected username
    char* actual_username = malloc_username_from_conf_file(); // Obtain the actual username from conf file
